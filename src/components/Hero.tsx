    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 pt-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            We Build{" "}
            <span className="text-gradient-gold">Modern</span>,{" "}
            <span className="text-gradient-gold">Responsive</span>, and{" "}
            <span className="text-gradient-gold">SEO-Friendly</span> Websites
          </motion.h1>
          ...
          >
            ...
            websites crafted with modern technologies and best practices.
          </motion.p>
